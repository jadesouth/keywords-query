...
<form id="main-form" class="form-horizontal">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" class="form-control" data-date-format="yyyy-mm-dd hh:ii" name="pub_date" id="pub_date" placeholder="发表日期" value="<?=$data['pub_date']?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="<?=base_url('index.php/admin/article/edit/'.$data['id'])?>" type="button" class="btn btn-primary">继续修改</a>
            </div>
        </div>
    </div>
</div>
