        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline" style="width: 100px;">
                    <button id="add-keywords" class="layui-btn"><i class="layui-icon">&#xe608;</i>&nbsp;&nbsp;添加旺旺关键字</button>
                </div>
            </div>
            <div class="layui-inline" style="margin-left:200px;">
                ...
                <div class="layui-input-inline" style="width: 100px;">
                    <button id="search-keywords" class="layui-btn"><i class="layui-icon">&#xe615;</i>&nbsp;&nbsp;查询旺旺关键字</button>
                </div>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="panel panel-default" style="border-radius:0;">
            <div class="panel-heading" style="border-radius:0;">
                <h3 class="panel-title">全部旺旺关键字</h3>
            </div>
